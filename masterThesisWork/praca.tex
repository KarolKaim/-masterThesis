...
\acknowledgements{Pragnę złożyć serdeczne podziękowania dla promotora pracy, dr Macieja Rosoła, za okazane wsparcie i pomoc w trakcie pisania niniejszej pracy dyplomowej.}
...
\input{./chapters/r1.tex}
\input{./chapters/r2.tex}
\input{./chapters/r3.tex}
\input{./chapters/r4.tex}
\input{./chapters/r5.tex}
\input{./chapters/r6.tex}
\input{./chapters/r7.tex}

% itd.
% \appendix
\input{./chapters/DodatekA.tex}
\input{./chapters/DodatekB.tex}
% \include{dodatekB}
% itd.
\printbibliography[heading=bibintoc,title={10. Bibliografia}]
%\printbibliography
