...
Pololu AltIMU10 to inercyjna jednoskta pomiarowa, w skład której wchodzą czujniki wykoanane w technologii MEMS:
\begin{itemize}
\item
...
Wszystkie czujniki zamontowane w jednostce komunikują się z urządzeniem nadrzędnym z wykorzystaniem magistrali I2C(z ang. {\em Inter-Intergrated Circuit}). Magistrala I2C jest szerogowym, dwukierunkowym interfejsem komunikacyjnym opracowanym przez fimę Philips. Układ AltImu10 posiada elementy pasywne, gwarantujące poprawne działanie magistrali, oraz wbudowany regulator napięcia.\textcolor{red}{@TODO przypisik z pracyInz}
